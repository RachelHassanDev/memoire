...
def extract(page, numOfPost, infinite_scroll=False, scrape_comment=False):
    ...
    if scrape_comment:
        ...
        rankDropdowns = browser.find_elements("class_name", '_2pln') #select boxes who have rank dropdowns
        ...
        for rankDropdown in rankDropdowns:
            ...
            ranked_unfiltered = browser.find_elements("xpath", rankXPath) # RANKED_UNFILTERED => (All Comments)
